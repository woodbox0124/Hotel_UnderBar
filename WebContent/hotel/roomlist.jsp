...
%>
		...
		<div class="card">
			...
			<div class="card-body">
				...
				<a href="RoomReservServlet?u_id=<%=u_id %>&checkin=<%=checkin%>&checkout=<%=checkout%>&guest=<%=guest%>&hotelseq=<%=hotelseq%>&roomseq=<%=seq%>&price=<%=price%>&location=<%=location%>" id="resv">바로예약</a>
				<ul>
